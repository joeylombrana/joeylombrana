document.addEventListener("DOMContentLoaded", () => {
  ...
  reviewForm.addEventListener("submit", async (e) => {
    ...
    const sheetPayload = {
      ...
      first_name: reviewForm.querySelector('[name="firstName"]').value,
      mi: reviewForm.querySelector('[name="mi"]').value,
      last_name: reviewForm.querySelector('[name="lastName"]').value,
      ...
      city: reviewForm.querySelector('[name="city"]').value,
      state: reviewForm.querySelector('[name="state"]').value,
      zip: reviewForm.querySelector('[name="zip"]').value,
      county: reviewForm.querySelector('[name="county"]').value,
